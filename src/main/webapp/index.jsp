            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="ad-auth-content">
                    <form action="${pageContext.request.contextPath}/login.do" name="actionForm" id="actionForm" method="post">
                        ...
                        <p>请在下面输入您的详细信息以继续</p>
                        <p style="color:indianred">${errorPassword}</p>
                        <div class="ad-auth-form">
                            <div class="ad-auth-feilds mb-30">
                                <input type="text" placeholder="输入账号" class="ad-input" name="userCode" required/>
                            ...
                            <div class="ad-auth-feilds">
                                <input type="password" placeholder="输入密码" class="ad-input" name="userPassword" required/>
                                <div class="ad-auth-icon">
                        ...
                        <div class="ad-other-feilds">
                            ...
                            <a class="forgot-pws-btn" href="${pageContext.request.contextPath}/forgot-pws.jsp">忘记密码？</a>
                        </div>
                        <div class="ad-auth-btn" >
                            <a class="ad-btn ad-login-member" style="color: white" onclick="document.getElementById('actionForm').submit();return false;">登 陆</a>
                        </div>
                        <p class="ad-register-text">没有账户？ <a href="${pageContext.request.contextPath}/register.jsp">点击这里</a></p>
                    </form>
                </div>
            </div>
        </div>
