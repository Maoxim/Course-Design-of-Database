        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="ad-auth-content">
                    <form action="${pageContext.request.contextPath}/forgot.do" name="actionForm" id="actionForm" method="post">
                        ...
                        <p style="color:indianred">${NotUserCode}</p>
                        <div class="ad-auth-form">
                            <div class="ad-auth-feilds mb-30">
                                <input type="text" placeholder="请输入您的学号" class="ad-input" name="userCode">
