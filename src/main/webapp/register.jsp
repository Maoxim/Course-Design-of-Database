        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="ad-auth-content">
                    <form action="${pageContext.request.contextPath}/register.do" name="actionForm" id="actionForm" method="post">
                        <a href="index.html" class="ad-auth-logo">
                            <img  src="static/picture/SCAU_TAG.webp" alt="">
                        </a>
                        <h2><span class="primary">你好，</span>欢迎使用！</h2>
                        <p>请在下面输入您的详细信息以继续！</p>
                        <p style="color:indianred">${userCodeExist}</p>
                        <div class="ad-auth-form">
                            <div class="ad-auth-feilds mb-30">
                                <input type="text" placeholder="请输入姓名" class="ad-input" name="userName" required/>
                            ...
                            <div class="ad-auth-feilds mb-30">
                                <input type="text" placeholder="请输入学号" class="ad-input" name="userCode" required/>
                                <div class="ad-auth-icon">
                            ...
                            <div class="ad-auth-feilds">
                                <input type="password" placeholder="请输入密码" class="ad-input"  name="userPassword" required/>
                                <div class="ad-auth-icon">
                        ...
                        <div class="ad-auth-btn">
                            <a href="javascript:void(0);" class="ad-btn ad-login-member" onclick="document.getElementById('actionForm').submit();return false;">注 册</a>
                        </div>
                        <p class="ad-register-text">已经有账户了？<a href="${pageContext.request.contextPath}/index.jsp">登陆</a></p>
                    </form>
                </div>
            </div>
        </div>
